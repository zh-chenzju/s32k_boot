...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration1[] = {
    ...
    {DMATCD0_IRQn, (boolean)TRUE, 0U, Dma0_Ch0_IRQHandler},
    {LPUART0_IRQn, (boolean)TRUE, 0U, LPUART0_LIN_IP_RxTx_IRQHandler},
    {LPUART1_IRQn, (boolean)TRUE, 0U, LPUART1_LIN_IP_RxTx_IRQHandler},
    {ADC0_IRQn, (boolean)FALSE, 0U, Adc_Sar_0_Isr},
