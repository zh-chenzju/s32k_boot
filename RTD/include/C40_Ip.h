...
#if (C40_IP_TYPES_VENDOR_ID_CFG != C40_IP_VENDOR_ID_H)
    #error "C40_Ip.h and C40_Ip_Types.h have different vendor ids"
#endif
/* Check if current file and C40_Ip_Types header file are of the same Autosar version */
#if ((C40_IP_TYPES_AR_RELEASE_MAJOR_VERSION_CFG    != C40_IP_AR_RELEASE_MAJOR_VERSION_H) || \
     (C40_IP_TYPES_AR_RELEASE_MINOR_VERSION_CFG    != C40_IP_AR_RELEASE_MINOR_VERSION_H) || \
     (C40_IP_TYPES_AR_RELEASE_REVISION_VERSION_CFG != C40_IP_AR_RELEASE_REVISION_VERSION_H) \
    )
    #error "AutoSar Version Numbers of C40_Ip.h and C40_Ip_Types.h are different"
#endif
/* Check if current file and C40_Ip_Types header file are of the same Software version */
#if ((C40_IP_TYPES_SW_MAJOR_VERSION_CFG != C40_IP_SW_MAJOR_VERSION_H) || \
     (C40_IP_TYPES_SW_MINOR_VERSION_CFG != C40_IP_SW_MINOR_VERSION_H) || \
     (C40_IP_TYPES_SW_PATCH_VERSION_CFG != C40_IP_SW_PATCH_VERSION_H) \
    )
    #error "Software Version Numbers of C40_Ip.h and C40_Ip_Types.h are different"
#endif

/* Check if current file and C40_Ip_Cfg header file are of the same vendor */
#if (FLS_C40_IP_VENDOR_ID_CFG != C40_IP_VENDOR_ID_H)
...
#if ((FLS_C40_IP_AR_RELEASE_MAJOR_VERSION_CFG    != C40_IP_AR_RELEASE_MAJOR_VERSION_H) || \
     (FLS_C40_IP_AR_RELEASE_MINOR_VERSION_CFG    != C40_IP_AR_RELEASE_MINOR_VERSION_H) || \
     (FLS_C40_IP_AR_RELEASE_REVISION_VERSION_CFG != C40_IP_AR_RELEASE_REVISION_VERSION_H) \
    )
...
#if ((FLS_C40_IP_SW_MAJOR_VERSION_CFG != C40_IP_SW_MAJOR_VERSION_H) || \
     (FLS_C40_IP_SW_MINOR_VERSION_CFG != C40_IP_SW_MINOR_VERSION_H) || \
     (FLS_C40_IP_SW_PATCH_VERSION_CFG != C40_IP_SW_PATCH_VERSION_H) \
    )
...
#define C40_DSI_EXC_SYNDROME                             (0x00008200U)
#endif
 ...
 *               If the compare is intented to be a blank check, the SourceAddressPtr should be NULL.
 *
 ...
 * @retval       STATUS_C40_IP_ERROR_INPUT_PARAM   The input parameters are invaid.
 * @retval       STATUS_C40_IP_ERROR               There is another job configured or in progress or
 *                                                 @p The sector is locked by another core or couldn't be unlocked.
 ...
 * @retval       STATUS_C40_IP_ERROR_PROGRAM_VERIFY   The data was not written corectly into the memory - Status available only of program verify feature is enabled
 *
 * @pre          The module has to be initialized.
 *
 */
 ...
 *
 * @param[in] pExceptionDetailsPtr         Exception detail structure to store infomation on the exeption.
 *
 ...
 *           Thanks for this param, writting and erasing will operate at synch or Asynch mode.
 *
 * @pre     The module has to be initialized
 *
 */
